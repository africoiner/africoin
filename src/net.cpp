...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Africoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"kr105.com", "africointestseeds.kr105.com"},
    {"africoin.info", "testseeds.africoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Africoin is probably already running."), addrBind.ToString().c_str());
        else
