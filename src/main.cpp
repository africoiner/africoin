...
const string strMessageMagic = "Africoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 170000 blocks, which will occur approximately every 3.2 years
    nSubsidy >>= (nHeight / 170000);
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040375a8eaf076cf0de2189483707aada2105554d242eb66237ef8a67811c6e54e2cb4789556162b1bb518c1fe5bb6be3f58a95e750dffc425df5d12bfd42f2ce3") << OP_CHECKSIG;
        CBlock block;
...
unsigned char pchMessageStart[4] = { 0xf0, 0xaf, 0x21, 0xc0 };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AfricoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AfricoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running AfricoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("AfricoinMiner terminated\n");
        throw;
    }
}
